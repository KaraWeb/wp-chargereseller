...
add_action('wp_footer', 'chargereseller_widget');
  //add_action('init', 'chargereseller_widget');
...
//add_action('init','payam');
function chargereseller_widget_admin()
{
	$file = WP_PLUGIN_DIR."/chargereseller_widget/config.json"; 
	$config = @json_decode(file_get_contents($file), true);
    if ($_POST) {
        $options = array('WebserviceId', 'DefaultOperator', 'DefaultChargeKind', 'WidgetColor', 'WidgetHorizontalPosition', 'WidgetVerticalPosition', 'WidgetTabPosition'); // this is for hack reasons
...
?>
    ...
    <script type="text/javascript" src="<?php echo  plugins_url(); ?>/chargereseller_widget/jscolor/jscolor.js"></script>
<?php
}
	
function chargereseller_widget()
{ 
	$config = json_decode(file_get_contents(WP_PLUGIN_DIR."/chargereseller_widget/config.json"), true);
?> 
	<link rel="stylesheet" type="text/css" href="<?php echo  plugins_url(); ?>/chargereseller_widget/css/ion.rangeSlider.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo  plugins_url(); ?>/chargereseller_widget/css/ion.rangeSlider.skinNice.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo  plugins_url(); ?>/chargereseller_widget/css/jquery.qtip.css" />
	<link rel="stylesheet" type="text/css" href="<?php echo  plugins_url(); ?>/chargereseller_widget/css/fontello.css" />
	...
	<script type="text/javascript" src="<?php echo  plugins_url(); ?>/chargereseller_widget/js/jquery-2.1.0.min.js"></script>
	<script type="text/javascript" src="<?php echo  plugins_url(); ?>/chargereseller_widget/js/jquery.qtip.min.js"></script>
	<script type="text/javascript" src="<?php echo  plugins_url(); ?>/chargereseller_widget/js/ion.rangeSlider.min.js"></script>
	<script type="text/javascript" src="<?php echo  plugins_url(); ?>/chargereseller_widget/js/charge.js"></script>
